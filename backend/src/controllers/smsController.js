...
const { Member, Group, MemberGroup, SmsLog } = require('../models');
...
async function logSms({ sender_id, role, recipient_type, recipient_member_id = null, group_id = null, recipient_count, message, status, error = null }) {
  try {
    await SmsLog.create({ sender_id, role, recipient_type, recipient_member_id, group_id, recipient_count, message, status, error });
  } catch (e) {
