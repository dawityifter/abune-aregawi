...
| householdReport.totalDependents | Dependents | ጽግዕተኛታት | 🔴 alternative to existing `ተደገፍቲ` (line 2809) — verify term choice |
...
| householdReport.dependentsSection | Dependents | ጽግዕተኛታት | 🔴 alternative to existing `ተደገፍቲ` (line 2809) — verify term choice |
