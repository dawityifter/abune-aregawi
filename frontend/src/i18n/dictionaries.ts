...
export const en: Dictionaries = {
  ...
  pledgeDashboard: {
    ...
    yoy: {
      ...
      caveatNoGoal: 'One of the two drives set no goal, so goal progress is not compared.',
      caveatNoCollections: 'One of the two drives has payments without dates, so collection timing is not compared.',
  ...
  "smsBroadcast.noLiveDrive": "No fundraising drive is running right now, so there is no pledge audience to text.",
  "smsBroadcast.targetingDrive": "Targeting {campaign}",
  "smsBroadcast.owesOfPledged": "${remaining} still owed of ${pledged} pledged",
  "smsBroadcast.paidInFull": "${pledged} pledged, paid in full",
...
export const ti: Dictionaries = {
  ...
  pledgeDashboard: {
    ...
    yoy: {
      ...
      caveatNoGoal: 'ሓደ ካብቶም ክልተ ወፈያታት ዕላማ ኣይነበሮን፣ ስለዚ ናይ ዕላማ ደረጃ ኣይነጻጸርን።',
      caveatNoCollections: 'ሓደ ካብቶም ክልተ ወፈያታት ክፍሊታቱ ዕለት የብሎምን፣ ስለዚ ግዜ ምእካብ ኣይነጻጸርን።',
  ...
  "smsBroadcast.noLiveDrive": "ሕጂ ዝካየድ ዘሎ ወፈያ የለን፡ ስለዚ መልእኽቲ ዝለኣኸሉ ናይ መብጽዓ ኣኼባ የለን።",
  "smsBroadcast.targetingDrive": "ዕላማ፦ {campaign}",
  "smsBroadcast.owesOfPledged": "ካብ ${pledged} መብጽዓ ${remaining} ተሪፉ",
  "smsBroadcast.paidInFull": "${pledged} መብጽዓ፡ ምሉእ ብምሉእ ተኸፊሉ",
