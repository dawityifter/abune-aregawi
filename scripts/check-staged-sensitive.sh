...
ALLOWLIST_RE='(env\.example|\.env\.example|env\.template|/__mocks__/|/fixtures/|scripts/check-staged-sensitive\.sh|campaignTotalsOverpayment\.test\.js|campaignTotalsHouseholds\.test\.js)'
